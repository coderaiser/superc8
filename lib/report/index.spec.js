...
test('superc8: report: _getSrc: should return src wrapped in array when string', async (t) => {
    const {Report} = await import('./index.js');
    const report = Report({});
...
test('superc8: report: _getSrc: should return src as is when array', async (t) => {
    const {Report} = await import('./index.js');
    const report = Report({});
...
test('superc8: report: _getSrc: should return cwd when not provided', async (t) => {
    const {Report} = await import('./index.js');
    const report = Report({});
